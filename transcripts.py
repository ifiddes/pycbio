...
from pycbio.fileOps import iter_lines
from pycbio.bio import convert_strand, reverse_complement, codon_to_amino_acid, translate_sequence
from pycbio.intervals import ChromosomeInterval
...
def get_gp_ids(gp):
    ...
    """
    return {x[0] for x in iter_lines(open(gp))}
